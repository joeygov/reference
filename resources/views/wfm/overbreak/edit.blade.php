    ...
    <div class="content-wrapper">
        <div class="row" id="account_row">
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        <form class="form-sample" method="POST" action="{{ route('overbreak.update', $overbreak->id) }}">
                            @csrf
                            <div class="form-group row schedule">
                                ...
                                <div class="col-sm-5">
                                    <select name="employee" id="employee_id" data-placeholder="Employee Name"
                                        class="chosen-select form-control form-control-md @error('employee') is-invalid @enderror">
                                        <option value="">~</option>
                                        @foreach ($employees as $key => $employee)
                                        <option value="{{ $key }}" {{ old('employee', $overbreak->employee_id) == $key ? 'selected' : '' }}>{{ $employee }} </option>
                                        @endforeach
                                    </select>
                                    @error('employee')
                            ...
                            <div class="form-group row schedule">
                                <label for="exampleInputEmail2" class="col-sm-3 col-form-label required">Date : </label>
                                <div class="col-sm-5">
                                    <input type="text" name="overbreak_date" id="overbreak_date" autocomplete="off"
                                        value="{{ old('overbreak_date', \Carbon\Carbon::parse($overbreak->overbreak_date)->format('m/d/Y')) }}"
                                        class="form-control form-control-lg @error('overbreak_date') is-invalid @enderror"
                            ...
                            <div class="form-group row schedule">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" name="break1" id="break1"
                                        value="{{ old('break1', $overbreak->break1) }}"
                            ...
                            <div class="form-group row schedule">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" name="break2" id="break2" value="{{ old('break2', $overbreak->break2) }}"
                            ...
                            <div class="form-group row schedule">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" name="break3" id="break3"
                                        value="{{ old('break3', $overbreak->break3) }}"
                            ...
                            <div class="form-group row schedule">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" name="break4" id="break4" value="{{ old('break4', $overbreak->break4) }}"
