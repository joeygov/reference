        ...
        <div class="row" id="account_row">
            <div class="col-12 grid-margin">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form-sample" method="POST" action="{{ route('account.update', $account->id) }}">
                            @csrf
                            <div class="form-group row acc_name">
                                <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Account Name : </label>
                                <div class="col-sm-5">
                                  <input type="text" name="account_name" value="{{ old('account_name', $account->name) }}" class="form-control form-control-lg @error('account_name') is-invalid @enderror" id="exampleInputEmail2" placeholder="Account Name">
                                    @error('account_name')
